...
export default function Generator() {
  ...
  const currentText =
    generated?.versions?.[generated.currentVersion]?.text || "";
      ...
      >
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            ...
            <textarea
              rows={3}
              placeholder="e.g. Why developers should learn system design in 2025"
              value={form.topic}
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              ...
              >
                {Object.entries(WORD_COUNT_LABELS).map(([k, v]) => (
              ...
              >
                <div style={{ display: "flex", gap: 8 }}>
                  <span className="badge badge-purple">
                    {CONTENT_TYPE_LABELS[generated.contentType]}
                  </span>
                  <span className="badge badge-green">
                    v{generated.currentVersion + 1} of{" "}
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  <button
                    ...
                    onClick={() =>
                      copyToClipboard(currentText).then(() =>
              ...
              {improvements && (
                ...
                >
                  ...
                  >
                    ...
                    <span>
                      Score: <strong>{improvements.score}/10</strong>
                    </span>
